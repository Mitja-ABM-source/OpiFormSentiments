...
opiform::Random::Random() : Pairing() {
}

opiform::Random::~Random() {
}

//------------------------------------------------------------------------------

void opiform::Random::init(const std::vector <class AgentBase * > & avecAgents) {
}

//------------------------------------------------------------------------------

bool opiform::Random::run(std::vector <class AgentBase * > * apvecAgents, Pairs & avecPairs) {
...
std::vector<opiform::Agent> opiform::Random::setPreferenceList(std::vector <class AgentBase * > * apvecAgents) {
	...
	//make a random choice among all agents
...
void opiform::Random::findfavorites(std::vector<struct Agent> * apvecAgents) {
...
void opiform::Random::reduceTable(std::vector<struct Agent> * apvecAgents, std::map<int, std::vector<int> > & amapReducedTable) {
...
bool opiform::Random::findAndReduceCycles(std::map<int, std::vector<int> > & amapReducedTable) {
